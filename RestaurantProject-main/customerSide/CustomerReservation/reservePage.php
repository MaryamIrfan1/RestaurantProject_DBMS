...
<body>
    <?php
        ...
        if ($reservationStatus === 'success') {
            ...
            '<h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">SAVOUR SPOT\'S</h1>' .
    ...
    <div class="reserve-container">
        <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;"> SAVOUR SPOT </h1>
